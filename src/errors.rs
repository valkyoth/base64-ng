...
pub enum EncodeError {
    ...
    LengthOverflow,
    /// The selected alphabet is invalid or has an inconsistent encoder.
    ///
    /// Built-in alphabets and alphabets generated by
    /// [`define_alphabet!`](crate::define_alphabet) cannot trigger this error.
    /// It is returned when a hand-written [`Alphabet`](crate::Alphabet)
    /// implementation violates the visible-ASCII table contract or overrides
    /// [`Alphabet::encode`](crate::Alphabet::encode) with results that differ
    /// from [`Alphabet::ENCODE`](crate::Alphabet::ENCODE).
    InvalidAlphabet,
...
impl core::fmt::Display for EncodeError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::InvalidAlphabet => f.write_str("base64 alphabet is invalid or inconsistent"),
