...
| CWE-208 Observable Timing Discrepancy | Secret comparison exits early on the first different byte | `SecretBuffer::constant_time_eq` provides a dependency-free constant-time-oriented comparison helper for equal-length inputs. |
