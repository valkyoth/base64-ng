...
decoding without changing this feature edge or adding dependencies. Secret
encoding follows in Commit 20. `checked-backend` remains an inert reservation
until Commit 24. Ordinary type layout and auto traits remain invariant when
either name is enabled.
