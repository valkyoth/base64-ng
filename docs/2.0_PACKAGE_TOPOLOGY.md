...
Its version is independent of the Rust package versions; the explicit `[npm]`
entry in `release-crates.toml` decides whether the package is published from a
given signed Rust release tag.
