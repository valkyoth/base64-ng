...
capability at Commit 18. Constant-time-oriented secret computation arrives in
Commits 19 and 20. `checked-backend` remains an inert reservation until Commit
24. Ordinary type layout and auto traits remain invariant when either name is
enabled.
