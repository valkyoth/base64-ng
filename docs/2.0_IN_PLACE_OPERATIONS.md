...
claimed to have the same whole-call timing as the invalid-input path. Commit 20
owns the final optimizer/assembly evidence and complete secret-codec timing
admission.
