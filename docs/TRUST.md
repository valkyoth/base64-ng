...
| 2.0 secret storage | `base64_ng::secret` separates redacted owners from explicitly exposed and declassified views; secret computation remains pending | `docs/2.0_SECRET_STORAGE_AND_EXPOSURE.md`, `scripts/check-2.0-secret-storage.sh` |
