...
interoperability traits. Secret computation remains assigned to Commits 19 and
20.
...
| `secrets` | New dependency-free capability; storage/exposure in Commit 18 and secret computation in Commits 19-21, with no implicit `alloc` edge |
...
explicit exposure; `checked-backend` remains inert until Commit 24. Neither is
a functional API in the published 1.3.9 baseline.
