...
It remains private so the frozen 1.3.9 public snapshot cannot accidentally
acquire a partial 2.0 surface. Commit 6 exposes the value only as part of the
sealed specification and runtime-codec construction contract.
