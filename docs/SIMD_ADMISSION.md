...
- Release status: `1.3.0`; `1.2.0` admitted conservative active encode
  dispatch, and `1.3.0` admits normal strict decode dispatch for the first
  narrow decode scope. Active encode dispatch admits AVX-512 VBMI above AVX2
