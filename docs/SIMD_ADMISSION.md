...
- Release status: `1.3.4`; `1.2.0` admitted conservative active encode
  ...
  Rust `s390x`/PowerPC64 intrinsic blocker. Active encode dispatch admits AVX-512 VBMI above AVX2
