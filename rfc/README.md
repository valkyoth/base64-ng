# RFC 4648, RFC 2045, RFC 3501, And RFC 7468 Reference Material
...
`rfc4648.txt`, `rfc2045.txt`, `rfc3501.txt`, and `rfc7468.txt` are byte-for-byte
identical to the HTTPS sources in `SOURCES`. Verified errata are not patched
into those files. Project dispositions are recorded separately in the matching
errata TSV.
