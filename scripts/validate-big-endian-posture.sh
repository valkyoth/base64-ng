...
require_text "$simd_doc" "Big-endian and SVE acceleration work follows a QEMU-first evidence path"
require_text "$simd_doc" "native evidence and production admission only for the exact Linux/SpacemiT"
require_text "$simd_doc" "Every other RISC-V profile remains"
require_text "$simd_doc" "production and retains QEMU-only candidate evidence"
