...
require_text "$review_doc" "scheduled for \`1.3.9\`"
require_text "$review_doc" "The \`1.3.8\` maintenance release does not change"
...
require_text "$simd_doc" "RVV proof and admission review is scheduled for \`1.3.9\`"
