...
require_text "$simd_doc" "Node/V8, Wasmtime, and Chromium-family browser runtime smoke evidence"
...
require_text "$admission_doc" "Node/V8, Wasmtime, and Chromium-family browser runtime smoke evidence"
require_text "$admission_doc" "Chromium-family browser runtime smoke evidence"
...
require_text "$browser_script" "BASE64_NG_BROWSER_WASM_SMOKE_PASS"
