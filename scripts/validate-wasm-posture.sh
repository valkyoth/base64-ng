...
require_text "$simd_doc" "Node/V8, Wasmtime, Chromium-family browser, and"
require_text "$simd_doc" "Firefox/SpiderMonkey runtime smoke evidence"
...
require_text "$admission_doc" "browser, and Firefox/SpiderMonkey runtime smoke evidence"
