...
for required_text in \
    ...
    "Admitted backends: AVX-512 VBMI encode, AVX2 encode, SSSE3/SSE4.1 encode, NEON encode, AVX-512 VBMI strict decode, AVX2 strict decode, and SSSE3/SSE4.1 strict decode" \
...
echo "simd admission: AVX-512 VBMI, AVX2, SSSE3/SSE4.1, NEON encode, AVX-512 VBMI strict decode, AVX2 strict decode, and SSSE3/SSE4.1 strict decode admission gate ok"
