...

{
    ...
    echo "The AVX-512 VBMI, AVX2, and SSSE3/SSE4.1 decode prototypes are fixed-block, non-dispatchable evidence only; public decode APIs still report scalar execution."
