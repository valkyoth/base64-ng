...

{
    ...
    echo "prototype_avx512_vbmi_decode=real-non-dispatchable"
    echo "prototype_avx2=admitted-encode-backend"
    echo "prototype_avx2_decode=real-non-dispatchable"
    ...
    echo "prototype_neon_decode=real-non-dispatchable-aarch64-standard-family"
    ...
    echo "The AVX-512 VBMI, AVX2, SSSE3/SSE4.1, and NEON decode prototypes are fixed-block, non-dispatchable evidence only; public decode APIs still report scalar execution."
