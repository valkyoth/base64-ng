...

{
    ...
    echo "strict_decode_neon=admitted-standard-url-safe-std-aarch64"
    ...
    echo "The AVX-512 VBMI, AVX2, SSSE3/SSE4.1, and NEON strict decode backends are admitted only for Standard and URL-safe std targets; unsupported decode surfaces still report scalar execution."
    ...
    echo "On AArch64 hosts, the admitted NEON path exercises real fixed-block vector encode and strict decode logic for Standard and URL-safe alphabets; 32-bit ARM remains scaffold evidence."
