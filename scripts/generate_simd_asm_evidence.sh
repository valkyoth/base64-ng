...

{
    ...
    echo
    echo "review focus:"
    echo "- SSSE3/SSE4.1 prototype contains byte shuffle and XMM operations"
    ...
    echo "- These artifacts are inactive prototype evidence only; runtime dispatch remains scalar-only"
} >"$manifest"
